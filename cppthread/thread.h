...
public:
    ...
    class cppthread_pool
    {
    public:
        typedef std::shared_ptr<cppthread_pool<W, A...>>  pointer_t;
    ...
    public:
         ...
         */
        cppthread_pool<W, A...>(std::string const & name
                             , size_t pool_size
                             , typename worker_fifo_t::pointer_t in
                             , typename worker_fifo_t::pointer_t out
                             , A... args)
    ...
    public:
         ...
         */
        cppthread_life(cppthread * const thread)
            : f_thread(thread)
        {
            if(f_thread == nullptr)
            {
        ...
        cppthread_life(cppthread_life const & rhs) = delete;
    ...
    private:
        ...
        cppthread *           f_thread = nullptr;
                                ...
                                cppthread(std::string const & name, snap_runner * runner);
                                ~cppthread();
